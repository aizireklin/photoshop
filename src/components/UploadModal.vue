<template>
  <div class="modal-wrapper">
    <div class="modal">
      ...
      <label>URL адрес: <input class="input" type="text" @change="saveNewUrl" v-model="url" /></label>
      <label>Файл: <input class="input" type="file" ref="inputFile" @change="saveNewFile" /></label>
      <button class="button"  @click="saveResult(), $emit('show'), $emit('download')" >Показать</button>
    </div>
  </div>
</template>
