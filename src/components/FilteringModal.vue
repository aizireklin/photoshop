    ...
    <div class="modal__line">
      ...
      <div class="modal__element matrix">
        <div class="matrix__line">
          <input class="matrix__input" type="number" @change="changeX1" v-model="x1"  />
          <input class="matrix__input" type="number" @change="changeX2" v-model="x2"  />
          <input class="matrix__input" type="number" @change="changeX3" v-model="x3"  />
        </div>
        <div class="matrix__line">
          <input class="matrix__input" type="number" @change="changeX4" v-model="x4"  />
          <input class="matrix__input" type="number" @change="changeX5" v-model="x5"  />
          <input class="matrix__input" type="number" @change="changeX6" v-model="x6"  />
        </div>
        <div class="matrix__line">
          <input class="matrix__input" type="number" @change="changeX7" v-model="x7"  />
          <input class="matrix__input" type="number" @change="changeX8" v-model="x8"  />
          <input class="matrix__input" type="number" @change="changeX9" v-model="x9"  />
        </div>
      </div>
